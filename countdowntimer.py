...
def Timer():
    ...
    while times > -1:
        ...
        if (times==0):
             playsound("Python/wav-wav-wavv meloboom.mp3")
             sec.set("00")
             mins.set("00")
             hrs.set("00")  
